        ...
        <>
            <Box sx={{ bgcolor: palette.primary.card, minHeight: "100vh" }}>
                ...
                <Container>
                    ...
                    >
                        <Box sx={{ flex: 2, p: 2 }}>
                            <Card sx={{ minWidth: 150, mb: 3, mt: 3, p: 2, bgcolor: palette.primary.filt }}>
                                <Box sx={{ pb: 2 }}>
                        ...
                        <Box sx={{ flex: 5, p: 2 }}>
                            ...
                            <Stack spacing={2}>
                                <Pagination color='secondary' variant="outlined" page={page} count={pages === 0 ? 1 : pages} onChange={(event, value) => setPage(value)} />
                            </Stack>
                        </Box>
                    </Stack>
                </Container>
